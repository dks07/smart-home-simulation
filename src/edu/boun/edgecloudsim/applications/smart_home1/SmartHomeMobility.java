...
package edu.boun.edgecloudsim.applications.smart_home1;
...
public class SmartHomeMobility extends MobilityModel {
	private List<TreeMap<Double, Location>> treeMapArray;
	private TreeMap<Integer, Location> deviceVsLocation;
	
	public SmartHomeMobility(int _numberOfMobileDevices, double _simulationTime) {
	...
	public Location getLocation(int deviceId, double time) {
		if(deviceVsLocation == null || !deviceVsLocation.containsKey(deviceId)) {
			...
			if(deviceVsLocation == null) {
				deviceVsLocation = new TreeMap<Integer, Location>();
			}
			deviceVsLocation.putIfAbsent(deviceId, location);
		}
		return deviceVsLocation.get(deviceId);
	}
