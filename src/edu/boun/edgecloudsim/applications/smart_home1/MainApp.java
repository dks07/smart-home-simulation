...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		if (args.length == 5){
			...
			configFile = "scripts/smart_home1/config/default_config.properties";
			applicationsFile = "scripts/smart_home1/config/applications.xml";
			edgeDevicesFile = "scripts/smart_home1/config/edge_devices.xml";
